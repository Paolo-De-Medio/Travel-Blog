<div class="container-fluid background-custom">
    <div class="row p-5 tc-second">
        <div class="col-12 col-md-7">
            ...
            <p class="fs-5 text-white">Paolo De Medio</p>
        ...
        <div class="col-12 col-md-5">
            ...
            <div>
                ...
                <div><i class="fab fa-twitter me-2 fs-4 mb-3"></i>Twitter</div>
                <div><i class="fab fa-linkedin-in me-2 fs-4 mb-3"></i>Linked-In</div>
            </div>
        </div>
    </div>
  </div>